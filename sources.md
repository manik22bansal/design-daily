...
| Craig Mod | craigmod.com | 4 | Long-form craft + attention |
| Linear Blog | linear.app/blog | 4 | Product craft from the most design-led startup |
| Khoi Vinh — Subtraction | subtraction.com | 3 | Veteran perspective |
| NN/g | nngroup.com | 3 | Research-backed UX; dry but rigorous |
| Smashing Magazine | smashingmagazine.com | 3 | Mixed; only the standout pieces |
...
| Source | URL | Score | Notes |
|---|---|---|---|
| Mobbin | mobbin.com | 4 | Real product UI patterns |
| Godly | godly.website | 4 | Top-tier web design |
| siteInspire | siteinspire.com | 4 | Curated web design |
...
| Awwwards | awwwards.com | 2.5 | High volume, uneven; only jury favourites |
...
| Core77 | core77.com | 3 | Industrial design |
| Framer Blog | framer.com/blog | 3 | Web design tooling |

## Voices & takes
| Source | URL | Score | Notes |
|---|---|---|---|
| Karri Saarinen | karrisaarinen.com | 4 | Linear's design philosophy |
| Soleio | x.com/soleio | 3 | Industry perspective, design hiring |
| John Maeda | x.com/johnmaeda | 3 | Design × technology reports |
| Jordan Singer | x.com/jsngr | 3 | AI × design tools |
| Mariana Castilho | ui.land | 3 | Craft curation + interviews |
...
| Source | Why |
|---|---|
| Sidebar.io | Shut down |
| Designer News | Dead |
| Read.cv / Posts.cv | Wound down after acquisition |
| AIGA Eye on Design | On indefinite hiatus — cite only its archive if exceptional |
| UX Collective (Medium) | Volume over quality; listicle-prone — individual pieces only if exceptional |
